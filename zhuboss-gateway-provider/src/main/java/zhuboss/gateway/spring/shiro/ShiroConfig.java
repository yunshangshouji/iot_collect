...
@Configuration(ShiroConfig.BEAN_NAME)
@ConditionalOnProperty(name = "spring.redis.shiro.host", matchIfMissing = false)
@ComponentScan
public class ShiroConfig {
    public static final String BEAN_NAME = "shiroConfig";
    public static boolean enable(){
        return SpringContextUtils.getApplicationContext().containsBean(BEAN_NAME);
    }
...
//        filterChainDefinitionMap.put("/"+PAGE_DIR+"/**", "anon");
